...
public class AplikasiBiodataMahasiswaGUI extends javax.swing.JFrame {

    int x=0;
    /**
     * Creates new form AplikasiBiodataMahasiswaGUI
     */
    public AplikasiBiodataMahasiswaGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cbJurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Teknik Informatika", "Sistem Informasi", "Teknik Mesin", "Teknik Elektro", "Teknik Industri", "Teknik Sipil", "Manajemen", "Hukum", "Administrasi Publik" }));
    ...
    try {
        ...
        try (BufferedWriter out = new BufferedWriter(new FileWriter("Biodata.txt"))) {
            out.write(Nama + Nim + Jurusan + Alamat + Phone);
            
            JOptionPane.showMessageDialog(null, "File Berhasil Disimpan");
        } catch (IOException ex) {
            Logger.getLogger(AplikasiBiodataMahasiswaGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AplikasiBiodataMahasiswaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AplikasiBiodataMahasiswaGUI().setVisible(true);
            }
        });
    }
